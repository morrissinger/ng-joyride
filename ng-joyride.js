...
(function (angular) {
    ...
    drctv.run(['$templateCache', function ($templateCache) {
        ...
        $templateCache.put('ng-joyride-title-tplv1.html',
            "<div id=\"ng-joyride-title-tplv1\"><div class=\"ng-joyride sharp-borders intro-banner\" style=\"\"><div class=\"popover-inner\"><h3 class=\"popover-title sharp-borders\">{{heading}}</h3><div class=\"popover-content container-fluid\"><div ng-bind-html=\"content\"></div><hr><div class=\"pull-right\"><button class=\"prevBtn btn\" type=\"button\"><i class=\"fa fa-chevron-left\"></i>&nbsp;Previous</button> <button id=\"nextTitleBtn\" class=\"nextBtn btn btn-primary\" type=\"button\">Next&nbsp;<i class=\"fa fa-chevron-right\"></i></button></div></div></div></div></div>"
        );
    }]);
    drctv.factory('joyrideElement', ['$timeout', '$compile', '$sce', function ($timeout, $compile, $sce) {
        function Element(config, currentStep, template, loadTemplateFn, hasReachedEndFn, goToNextFn, goToPrevFn, skipDemoFn,isEnd, curtainClass , addClassToCurtain, shouldDisablePrevious) {
            ...
            this.popoverTemplate = '<div class=\"row\"><div id=\"pop-over-text\" class=\"col-md-12\">' + this.content + '</div></div><hr><div class=\"pull-right\"><button id=\"prevBtn\" class=\"prevBtn btn\" type=\"button\"><i class=\"fa fa-chevron-left\"></i>&nbsp;Previous</button> <button id=\"nextBtn\" class=\"nextBtn btn btn-primary\" type=\"button\">' + _generateTextForNext() + '</button></div>';
            ...
            function _generateTextForNext() {
                ...
                if (isEnd) {
                    ...
                    return 'Next&nbsp;<i class=\"fa fa-chevron-right\">'
        ...
        Title.prototype = (function () {
            ...
            function _compilePopover(html) {
                ...
                if (this.hasReachedEndFn()) {
                    ...
                    $('.nextBtn').html("Next&nbsp;<i class='fa fa-chevron-right'>");
                }
